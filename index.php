...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="assets/images/cglogo.ico">
        <!-- Bootstrap Css -->
    ...
    <body data-topbar="dark">
                    ...
                    <div class="d-flex">
                        ...
                        <div class="navbar-brand-box">
                            <a href="index.html" class="logo logo-dark">
                                <span class="logo-lg">
                                <img src="assets/images/chips_logo.jpg" height="30" class="logo-dark mx-auto" alt="">
                                </span>
                            </a>
                    ...
                    <div class="d-flex">
                        <div class="dropdown d-inline-block user-dropdown">
                            <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                                ...
                                <span><i class="mdi mdi-chevron-down d-none d-xl-inline-block"></i></span>
                            </button>
        ...
        <script src="assets/js/remix-icons-list.js"></script>
